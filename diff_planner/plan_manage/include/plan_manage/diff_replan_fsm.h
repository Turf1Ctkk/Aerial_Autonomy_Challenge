...
namespace diff_planner
{
  ...
  private:
    ...
    bool enable_dynamic_temp_goal_;
    bool dynamic_collision_use_2d_;
    bool flag_hover_avoid_;
    bool using_dynamic_temp_goal_;
    std::string dynamic_object_topic_;
    double dynamic_collision_clearance_;
    double dynamic_collision_prediction_time_;
    double dynamic_collision_time_offset_;
    double dynamic_collision_uncertainty_scale_;
    double dynamic_collision_min_speed_;
    double dynamic_temp_goal_horizon_;
    double dynamic_temp_goal_trigger_distance_;
    double dynamic_temp_goal_min_force_;
    double dynamic_temp_goal_repulsion_gain_;
    double dynamic_temp_goal_return_distance_;
    ...
    Eigen::Vector3d hover_pos_, saved_final_goal_;
    ...
    bool computeDynamicTempGoal(Eigen::Vector3d &temp_goal);
    bool planDynamicTempGoal(bool from_wait_state);

...
namespace diff_planner
{
  ...
  private:
    ...
    bool enable_dynamic_obs_;
    double dynamic_obs_weight_;
    double dynamic_obs_clearance_;
    double dynamic_obs_prediction_time_;
    double dynamic_obs_time_offset_;
    double dynamic_obs_uncertainty_scale_;
    double dynamic_obs_min_speed_;
    bool dynamic_obs_use_2d_;

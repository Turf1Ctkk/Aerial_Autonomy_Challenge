...
public:
	...
	PositionAdrc position_adrc_;
	ros::Time last_position_adrc_timestamp_{ros::Time(0)};
	Eigen::Vector3d last_position_adrc_control_acc_{Eigen::Vector3d::Zero()};
	bool position_adrc_runtime_active_{false};
	...
	void resetPositionAdrc(const Odom_Data_t &odom);

	void setPositionAdrcActive(const bool active, const Odom_Data_t &odom);

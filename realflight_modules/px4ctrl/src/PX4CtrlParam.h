...
public:
	...
	{
		bool enable;
		std::array<bool, 3> axis_enable;
		std::array<double, 3> beta1;
		std::array<double, 3> beta2;
		std::array<double, 3> beta3;
		std::array<double, 3> b0;
		std::array<double, 3> fal_delta;
		std::array<double, 3> comp_gain;
		std::array<double, 3> deadband;
		double horizontal_deadband;
		std::array<double, 3> leak_rate;
		std::array<double, 3> max_dist_acc;
	};
